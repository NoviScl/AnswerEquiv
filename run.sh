...
--output_dir /data3/private/clsi/OpenQA/AmbigQA/out/reader_nq_new_seed100 \
--train_file $nq_train \
...
--topk_answer 10 \
--learning_rate 3e-5 \
--checkpoint /data3/private/clsi/OpenQA/AmbigQA/out/reader_nq_new_seed100/best-model.pt
